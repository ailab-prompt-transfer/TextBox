...
Word = namedtuple("Word", ["pos", "word", "lemma", "tag", "morph", "head", "func", "proj_head", "proj_func"])
...
def read_sentences(fobj):
    ...
    for line in fobj:
        ...
        sentence.append(Word(int(pos), word, lemma, tag2, morph, int(head), func, int(proj_head), proj_func))
