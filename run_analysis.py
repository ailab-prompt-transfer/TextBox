...
def show_results(models, results, charts):
    ...
    table.set_global_opts(title_opts=ComponentTitleOpts(title="Main Results"))
    charts.add(table)
    ...
    for i, feature in enumerate(features):
        ...
        chart.set_global_opts(
            ...
            xaxis_opts=opts.AxisOpts(
                name="Ngram" if feature == "Ngram Overlap" else "",
                axislabel_opts=opts.LabelOpts(**default_text_style),
                name_textstyle_opts=opts.TextStyleOpts(**default_text_style),
            ),
...
def wordcloud(models, dataset, corpora, charts):
    ...
    for model, texts in zip(models, corpora):
        ...
        chart.add(
            ...
            tooltip_opts=opts.TooltipOpts(textstyle_opts=opts.TextStyleOpts(**default_text_style)),
            textstyle_opts=opts.TextStyleOpts(**default_text_style),
        )
