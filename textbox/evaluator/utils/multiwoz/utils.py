...
class Vocab(object):
    def __init__(self, vocab_size=0):
        ...
        self._word2idx = {}
        self._freq_dict = {}
        for w in ["<pad>", "<go_r>", "<unk>", "<go_b>", "<go_a>", "<eos_u>", "<eos_r>", "<eos_b>", "<eos_a>", "<go_d>", "<eos_d>"]:
...
def padSeqs(sequences, maxlen=None, truncated=False, pad_method="post", trunc_method="pre", dtype="int32", value=0.0):
